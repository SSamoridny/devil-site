...
export default function HomePage(props){
        ...
        <div className="container">
          ...
          <section className="info info--yellow">
            <div className="inner-container">
              <div className="text">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos architecto sed consequuntur in iure consectetur fuga, aut doloribus fugit provident rem corrupti, odio doloremque quos repudiandae, tempora laudantium ducimus deleniti nisi obcaecati quisquam voluptatum? Praesentium, doloremque? Temporibus beatae, iure accusamus earum impedit harum doloremque illum repudiandae enim facilis esse natus nihil vero officiis rerum quidem similique voluptate sapiente consequatur eveniet distinctio aperiam delectus culpa pariatur? Laudantium dolore libero tempore corrupti. Beatae esse eos pariatur eveniet amet minus non quo accusantium quisquam voluptas doloremque facere assumenda, natus magni ipsa? Quas non blanditiis at dolore dolores, et eveniet reprehenderit perspiciatis labore fuga recusandae aliquid. Libero vitae molestias cupiditate</p> 
              </div>
          ...
          <section style={{paddingBottom: '0px'}} className="info info--green info--faq">
            <div className="inner-container">
              ...
              <p>Head over to the Discord, jump in on the conversation and let us know your ideas! </p>
    ...
    <VerticalTimeline>
      <VerticalTimelineElement
        ...
        contentArrowStyle={{ borderRight: '0px solid  rgb(255, 255, 255)' }}
      >
        <h3 className="vertical-timeline-element-title font-serif">
          DDS Collective Fund 🏧
        </h3>
        <p className="font-cursive">
          A Collective fund run by the Devil Club (you guys and me) supporting
          small NFT Artists and also making profit (for all of us) while doing
          that, and also putting it back in the community.
        </p>
      </VerticalTimelineElement>
      <VerticalTimelineElement
        className="vertical-timeline-element--work"
      ...
      >
        ...
        <p className="font-cursive">
          First of the many events, that start after the launch. Runs for a
          week, includes burning, involves other NFT community artists, and
          physical 👀 gifts (check out the{' '}
      ...
      >
        ...
        <p className="font-cursive">
          The &apos;Bucket List&apos;. Where does all the ETH from the community
          wallet go? To complete everything on the Bucket List! Through
          community voting, we can remove, as well as add new items.
        </p>
      </VerticalTimelineElement>
    </VerticalTimeline>
