...
export default function Art() {
  return (
    ...
    //     <h1 className="pl-5" style={{ fontFamily: "scary", fontSize: "8rem", color: 'white' }}>ART</h1>
    //     <div class="carousel-inner pb-5">
    //         <div class="carousel-item active" data-bs-interval="5000">
    //             <img src={art0} class="art w-25 p-2" alt="" />
    //             <img src={art1} class="art w-25 p-2" alt="" />
    //             <img src={art2} class="art w-25 p-2" alt="" />
    //             <img src={art3} class="art w-25 p-2" alt="" />
    //         </div>
    //         <div class="carousel-item" data-bs-interval="5000">
    //             <img src={art4} class="art w-25 p-2" alt="" />
    //             <img src={art5} class="art w-25 p-2" alt="" />
    //             <img src={art6} class="art w-25 p-2" alt="" />
    //             <img src={art7} class="art w-25 p-2" alt="" />
    //         </div>
    //         <div class="carousel-item" data-bs-interval="5000">
    //             <img src={art8} class="art w-25 p-2" alt="" />
    //             <img src={art9} class="art w-25 p-2" alt="" />
    //             <img src={art10} class="art w-25 p-2" alt="" />
    //             <img src={art11} class="art w-25 p-2" alt="" />
    //         </div>
    //         <div class="carousel-item" data-bs-interval="5000">
    //             <img src={art12} class="art w-25 p-2" alt="" />
    //             <img src={art13} class="art w-25 p-2" alt="" />
    //             <img src={art14} class="art w-25 p-2" alt="" />
    //             <img src={art15} class="art w-25 p-2" alt="" />
    //         </div>
    //     </div>
